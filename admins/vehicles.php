...
// Fetch all vehicles
$vehiclesQuery = $conn->query("SELECT * FROM vehicles ORDER BY car_brand");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Vehicles - VehiCare Admin</title>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <a href="/vehicare_db/admins/vehicles.php" class="active"><i class="fas fa-car"></i>Vehicles</a>
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    <?php if ($vehiclesQuery && $vehiclesQuery->num_rows > 0): ?>
                        ...
                        <tr>
                            <td><strong>#<?php echo $vehicle['vehicle_id']; ?></strong></td>
                            <td><?php echo htmlspecialchars($vehicle['owner_name'] ?? 'N/A'); ?></td>
                            <td><?php echo htmlspecialchars($vehicle['registration_number'] ?? 'N/A'); ?></td>
